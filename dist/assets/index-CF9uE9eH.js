...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Fs=/'/g,Gs=/"/g,_i=/^(?:script|style|textarea|title)$/i,jr=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),C=jr(1),be=Symbol.for("lit-noChange"),T=Symbol.for("lit-nothing"),Hs=new WeakMap,ke=xe.createTreeWalker(xe,129);function Si(s,e){if(!ps(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ns!==void 0?Ns.createHTML(e):e}const Mr=(s,e)=>{const t=s.length-1,i=[];let r,n=e===2?"<svg>":e===3?"<math>":"",o=ze;for(let a=0;a<t;a++){const l=s[a];let c,h,u=-1,p=0;for(;p<l.length&&(o.lastIndex=p,h=o.exec(l),h!==null);)p=o.lastIndex,o===ze?h[1]==="!--"?o=zs:h[1]!==void 0?o=qs:h[2]!==void 0?(_i.test(h[2])&&(r=RegExp("</"+h[2],"g")),o=ve):h[3]!==void 0&&(o=ve):o===ve?h[0]===">"?(o=r??ze,u=-1):h[1]===void 0?u=-2:(u=o.lastIndex-h[2].length,c=h[1],o=h[3]===void 0?ve:h[3]==='"'?Gs:Fs):o===Gs||o===Fs?o=ve:o===zs||o===qs?o=ze:(o=ve,r=void 0);const b=o===ve&&s[a+1].startsWith("/>")?" ":"";n+=o===ze?l+Pr:u>=0?(i.push(c),l.slice(0,u)+wi+l.slice(u)+fe+b):l+fe+(u===-2?a:b)}return[Si(s,n+(s[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class Xe{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let n=0,o=0;const a=e.length-1,l=this.parts,[c,h]=Mr(e,t);if(this.el=Xe.createElement(c,i),ke.currentNode=this.el.content,t===2||t===3){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(r=ke.nextNode())!==null&&l.length<a;){if(r.nodeType===1){if(r.hasAttributes())for(const u of r.getAttributeNames())if(u.endsWith(wi)){const p=h[o++],b=r.getAttribute(u).split(fe),E=/([.?@])?(.*)/.exec(p);l.push({type:1,index:n,name:E[2],strings:b,ctor:E[1]==="."?Dr:E[1]==="?"?Ur:E[1]==="@"?Nr:xt}),r.removeAttribute(u)}else u.startsWith(fe)&&(l.push({type:6,index:n}),r.removeAttribute(u));if(_i.test(r.tagName)){const u=r.textContent.split(fe),p=u.length-1;if(p>0){r.textContent=wt?wt.emptyScript:"";for(let b=0;b<p;b++)r.append(u[b],Ye()),ke.nextNode(),l.push({type:2,index:++n});r.append(u[p],Ye())}}}else if(r.nodeType===8)if(r.data===Ci)l.push({type:2,index:n});else{let u=-1;for(;(u=r.data.indexOf(fe,u+1))!==-1;)l.push({type:7,index:n}),u+=fe.length-1}n++}}static createElement(e,t){const i=xe.createElement("template");return i.innerHTML=e,i}}function Pe(s,e,t=s,i){if(e===be)return e;let r=i!==void 0?t._$Co?.[i]:t._$Cl;const n=Je(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),n===void 0?r=void 0:(r=new n(s),r._$AT(s,t,i)),i!==void 0?(t._$Co??=[])[i]=r:t._$Cl=r),r!==void 0&&(e=Pe(s,r._$AS(s,e.values),r,i)),e}class Br{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,r=(e?.creationScope??xe).importNode(t,!0);ke.currentNode=r;let n=ke.nextNode(),o=0,a=0,l=i[0];for(;l!==void 0;){if(o===l.index){let c;l.type===2?c=new Be(n,n.nextSibling,this,e):l.type===1?c=new l.ctor(n,l.name,l.strings,this,e):l.type===6&&(c=new zr(n,this,e)),this._$AV.push(c),l=i[++a]}o!==l?.index&&(n=ke.nextNode(),o++)}return ke.currentNode=xe,r}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Be{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,r){this.type=2,this._$AH=T,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Pe(this,e,t),Je(e)?e===T||e==null||e===""?(this._$AH!==T&&this._$AR(),this._$AH=T):e!==this._$AH&&e!==be&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Lr(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==T&&Je(this._$AH)?this._$AA.nextSibling.data=e:this.T(xe.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,r=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=Xe.createElement(Si(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.p(t);else{const n=new Br(r,this),o=n.u(this.options);n.p(t),this.T(o),this._$AH=n}}_$AC(e){let t=Hs.get(e.strings);return t===void 0&&Hs.set(e.strings,t=new Xe(e)),t}k(e){ps(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,r=0;for(const n of e)r===t.length?t.push(i=new Be(this.O(Ye()),this.O(Ye()),this,this.options)):i=t[r],i._$AI(n),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const i=Us(e).nextSibling;Us(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class xt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,r,n){this.type=1,this._$AH=T,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=T}_$AI(e,t=this,i,r){const n=this.strings;let o=!1;if(n===void 0)e=Pe(this,e,t,0),o=!Je(e)||e!==this._$AH&&e!==be,o&&(this._$AH=e);else{const a=e;let l,c;for(e=n[0],l=0;l<n.length-1;l++)c=Pe(this,a[i+l],t,l),c===be&&(c=this._$AH[l]),o||=!Je(c)||c!==this._$AH[l],c===T?e=T:e!==T&&(e+=(c??"")+n[l+1]),this._$AH[l]=c}o&&!r&&this.j(e)}j(e){e===T?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Dr extends xt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===T?void 0:e}}class Ur extends xt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==T)}}class Nr extends xt{constructor(e,t,i,r,n){super(e,t,i,r,n),this.type=5}_$AI(e,t=this){if((e=Pe(this,e,t,0)??T)===be)return;const i=this._$AH,r=e===T&&i!==T||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==T&&(i===T||r);r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class zr{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Pe(this,e)}}const qr={I:Be},Fr=hs.litHtmlPolyfillSupport;Fr?.(Xe,Be),(hs.litHtmlVersions??=[]).push("3.3.2");const Gr=(s,e,t)=>{const i=t?.renderBefore??e;let r=i._$litPart$;if(r===void 0){const n=t?.renderBefore??null;i._$litPart$=r=new Be(e.insertBefore(Ye(),n),n,void 0,t??{})}return r._$AI(s),r};const fs=globalThis;let B=class extends Ie{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Gr(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return be}};B._$litElement$=!0,B.finalized=!0,fs.litElementHydrateSupport?.({LitElement:B});const Hr=fs.litElementPolyfillSupport;Hr?.({LitElement:B});(fs.litElementVersions??=[]).push("4.2.2");const Z=s=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(s,e)}):customElements.define(s,e)};const Wr={attribute:!0,type:String,converter:vt,reflect:!1,hasChanged:us},Vr=(s=Wr,e,t)=>{const{kind:i,metadata:r}=t;let n=globalThis.litPropertyMetadata.get(r);if(n===void 0&&globalThis.litPropertyMetadata.set(r,n=new Map),i==="setter"&&((s=Object.create(s)).wrapped=!0),n.set(t.name,s),i==="accessor"){const{name:o}=t;return{set(a){const l=e.get.call(this);e.set.call(this,a),this.requestUpdate(o,l,s,!0,a)},init(a){return a!==void 0&&this.C(o,void 0,s,a),a}}}if(i==="setter"){const{name:o}=t;return function(a){const l=this[o];e.call(this,a),this.requestUpdate(o,l,s,!0,a)}}throw Error("Unsupported decorator location: "+i)};function te(s){return(e,t)=>typeof t=="object"?Vr(s,e,t):((i,r,n)=>{const o=r.hasOwnProperty(n);return r.constructor.createProperty(n,i),o?Object.getOwnPropertyDescriptor(r,n):void 0})(s,e,t)}function A(s){return te({...s,state:!0,attribute:!1})}const Kr=(s,e,t)=>(t.configurable=!0,t.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(s,e,t),t);function k(s,e){return(t,i,r)=>{const n=o=>o.renderRoot?.querySelector(s)??null;return Kr(t,i,{get(){return n(this)}})}}const Ei={ATTRIBUTE:1,CHILD:2},ms=s=>(...e)=>({_$litDirective$:s,values:e});let gs=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};const ki=ms(class extends gs{constructor(s){if(super(s),s.type!==Ei.ATTRIBUTE||s.name!=="class"||s.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(s){return" "+Object.keys(s).filter(e=>s[e]).join(" ")+" "}update(s,[e]){if(this.st===void 0){this.st=new Set,s.strings!==void 0&&(this.nt=new Set(s.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in e)e[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(e)}const t=s.element.classList;for(const i of this.st)i in e||(t.remove(i),this.st.delete(i));for(const i in e){const r=!!e[i];r===this.st.has(i)||this.nt?.has(i)||(r?(t.add(i),this.st.add(i)):(t.remove(i),this.st.delete(i)))}return be}}),xi={Catppuccin:"catppuccin",Dracula:"dracula",Gruvbox:"gruvbox",Dark:"dark",Light:"light",Sakura:"sakura",Matcha:"matcha",Lavender:"lavender"};class Zr{constructor(){this.listeners=new Map}on(e,t=g.Anonymous,i){this.listeners.has(e)||this.listeners.set(e,[]);const r=this.listeners.get(e);return r.push({callBack:i,subscriberName:t}),V.log(g.Bus,`On: "${String(e)}" | Registriert von: [${t}] (Gesamt: ${r.length})`),{unsubscribe:()=>this.off(e,i)}}off(e,t){const i=this.listeners.get(e);if(!i)return;const r=i.filter(n=>n.callBack!==t);r.length===0?this.listeners.delete(e):this.listeners.set(e,r)}emit(e,t=g.Anonymous,...i){const r=i[0],n=this.listeners.get(e)||[];if(V.log(g.Bus,`Emit: "${String(e)}" | Von: [${t}] | Empfänger: ${n.length}`),n.length===0){V.warn(g.Bus,`[Bus]  Warnung: Niemand hört auf "${String(e)}"!`);return}[...n].forEach(o=>{V.log(g.Bus,`==> Zustellung an: [${o.subscriberName}]`),o.callBack(r)})}once(e,t=g.Anonymous,i){const r=n=>{this.off(e,r),i(n)};this.on(e,t,r)}}const y=new Zr;function D(s,e=g.WebUI){return function(t,i,r){const n=t.connectedCallback,o=t.disconnectedCallback,a=Symbol(`sub_${i}`);t.connectedCallback=function(){n&&n.call(this);const l=r.value.bind(this);this[a]=y.on(s,e,l)},t.disconnectedCallback=function(){this[a]&&this[a].unsubscribe(),o&&o.call(this)}}}function st(s,e=g.WebUI){return function(t,i,r){const n=r.value;return r.value=function(...o){const a=n.apply(this,o);return a instanceof Promise?a.then(l=>{y.emit(s,e,a)}):y.emit(s,e,a),a},r}}function*Yr(s,e){if(s!==void 0){let t=0;for(const i of s)yield e(i,t++)}}const me={Logo:C` <svg class="logo-icon sidebar-logo" viewBox="0 0 1000 1000">
  ...
  `;Yt=tn([Z("game-logo")],Yt);const{I:sn}=qr,Ws=s=>s,Vs=()=>document.createComment(""),qe=(s,e,t)=>{const i=s._$AA.parentNode,r=e===void 0?s._$AB:e._$AA;if(t===void 0){const n=i.insertBefore(Vs(),r),o=i.insertBefore(Vs(),r);t=new sn(n,o,s,s.options)}else{const n=t._$AB.nextSibling,o=t._$AM,a=o!==s;if(a){let l;t._$AQ?.(s),t._$AM=s,t._$AP!==void 0&&(l=s._$AU)!==o._$AU&&t._$AP(l)}if(n!==r||a){let l=t._$AA;for(;l!==n;){const c=Ws(l).nextSibling;Ws(i).insertBefore(l,r),l=c}}}return t},we=(s,e,t=s)=>(s._$AI(e,t),s),rn={},$i=(s,e=rn)=>s._$AH=e,nn=s=>s._$AH,jt=s=>{s._$AR(),s._$AA.remove()};const on=ms(class extends gs{constructor(){super(...arguments),this.key=T}render(s,e){return this.key=s,e}update(s,[e,t]){return e!==this.key&&($i(s),this.key=e),t}});var an=Object.defineProperty,ln=Object.getOwnPropertyDescriptor,z=(s,e,t,i)=>{for(var r=i>1?void 0:i?ln(e,t):e,n=s.length-1,o;n>=0;n--)(o=s[n])&&(r=(i?o(e,t,r):o(r))||r);return i&&r&&an(e,t,r),r};let L=class extends B{constructor(){super(),this.settings=new re,this.cellRadius="5%",this.turnNumber=1,this.currentPlayer="",this.winnerMessage="",this.gameId=0,this.cells=[]}willUpdate(s){s.has("settings")&&(this.initBoard(),this.winnerMessage="",this.turnNumber=1,this.gameId++)}initBoard(){this.cells=Array.from({length:this.settings.boardSize},()=>Array(this.settings.boardSize).fill(""))}onBoardState(s){this.cells=s.grid.map(e=>e.map(t=>t||""))}onMoveMade(s){if(this.turnNumber=s.turn,this.currentPlayer=s.nextPlayerSymbol,s?.grid){this.cells=s.grid.map(e=>[...e]);return}typeof s.row=="number"&&typeof s.col=="number"&&this.updateCell(s.row,s.col,s.symbol)}onMoveApplied(s){if(this.turnNumber=s.turn,s?.board&&(s.action==="rotate"||s.row<0||s.col<0)){this.applyBoardSnapshot(s.board);return}typeof s.row=="number"&&typeof s.col=="number"&&s.row>=0&&s.col>=0&&this.updateCell(s.row,s.col,s.symbol??"")}async onGameFinished(s){this.winnerMessage=s.winner?`${s.winner} hat gewonnen!`:"Unentschieden!",await this.showWinAnimation(s)}onSettingsChanged(s){JSON.stringify(this.settings)!==JSON.stringify(s)&&(this.settings=Object.assign(new re,s)),this.initBoard()}onBoardSnapshotUpdated(s){!s?.size||!Array.isArray(s.state)||this.applyBoardSnapshot(s)}onReset(s){s?.settings&&JSON.stringify(this.settings)!==JSON.stringify(s.settings)&&(this.settings=Object.assign(new re,s.settings)),this.resetBoard()}render(){return C`
      <style>
        .grid {
          display: grid;
          gap: 0.5rem;
    ...
    `}_handleEndClick(){y.emit(m.UI.AppEndRequested,g.WebUI)}_handleCellClick(s){const e=s.target.closest("button.cell-btn");if(!e)return;e.classList.contains("spin")&&(e.classList.remove("spin"),requestAnimationFrame(()=>{requestAnimationFrame(()=>{e.classList.add("spin")})}));const t={row:parseInt(e.dataset.row),col:parseInt(e.dataset.col)};this.cells[t.row][t.col]===""&&this.winnerMessage===""&&y.emit(m.UI.CellClicked,g.WebUI,t)}_handleResetClick(){y.emit(m.UI.ResetRequested,g.WebUI)}_handleRotateClick(s){y.emit(m.UI.RotateRequested,g.WebUI,s)}updateCell(s,e,t){const i=[...this.cells];i[s][e]=t,this.cells=i}applyBoardSnapshot(s,e=""){const t=Array.from({length:s.size},()=>Array(s.size).fill(""));s.state.forEach((i,r)=>{const n=Math.floor(r/s.size),o=r%s.size;t[n][o]=i?e||String(i):""}),this.cells=t}resetBoard(){this.gameId++,this.initBoard(),this.winnerMessage="",this.turnNumber=1}async showWinAnimation(s){const e=this.gameId;if(s.type===Q.Draw||!s.positions)return;s.type===Q.DiagonalAnti&&s.positions.sort((n,o)=>o.row-n.row);const t=this.getLineConfig(s.type),i=s.positions.map(n=>this.shadowRoot?.getElementById(`btn-${n.row}-${n.col}`)).filter(n=>!!n),r=i.map(n=>(n.classList.add("win","spin"),new Promise(o=>{n.addEventListener("animationend",()=>o(),{once:!0})})));if(await Promise.all(r),this.gameId===e&&(i.forEach(n=>{n.style.setProperty("--after-width",t.width),n.style.setProperty("--line-top",t.top),n.style.setProperty("--line-left",t.left),n.style.setProperty("--angle",t.angle)}),await new Promise(n=>setTimeout(n,200)),this.gameId===e))for(const n of i)n.classList.add("draw-line"),await new Promise(o=>{n.addEventListener("transitionend",()=>o(),{once:!0})})}getLineConfig(s){const t=this.cellRadius==="50%"?1.17:1;switch(s){case Q.Horizontal:return{top:"50%",left:"0%",angle:"0deg",width:"100%"};case Q.Vertical:return{top:"0%",left:"50%",angle:"90deg",width:"100%"};case Q.DiagonalMain:return{top:"0%",left:"0%",angle:"45deg",width:`${t*141}%`};case Q.DiagonalAnti:return{top:"100%",left:"0%",angle:"-45deg",width:`${t*141}%`};default:return{top:"50%",left:"0%",angle:"0deg",width:"100%"}}}};L.styles=ee`
    :host {
      display: flex;
      flex-direction: column;
      width: 100%;
  ...
  `;ye([te({type:Boolean,reflect:!0})],oe.prototype,"open",2);ye([A()],oe.prototype,"messages",2);ye([A()],oe.prototype,"emojiPickerOpen",2);ye([k(".chat-content")],oe.prototype,"container",2);ye([k("#chat-input")],oe.prototype,"input",2);ye([D(m.Chat.MessageReceived,g.WebUI)],oe.prototype,"onChatMessage",1);ye([D(m.Chat.MessageReactionReceived,g.WebUI)],oe.prototype,"onReaction",1);oe=ye([Z("chat-drawer")],oe);const Ko=s=>s??T;var Zo=Object.defineProperty,Yo=Object.getOwnPropertyDescriptor,$t=(s,e,t,i)=>{for(var r=i>1?void 0:i?Yo(e,t):e,n=s.length-1,o;n>=0;n--)(o=s[n])&&(r=(i?o(e,t,r):o(r))||r);return i&&r&&Zo(e,t,r),r};let je=class extends B{constructor(){super(...arguments),this.variant="ghost",this.disabled=!1,this.ariaLabel=""}render(){return C`
      <button
        type="button"
  ...
  `;$t([te()],je.prototype,"variant",2);$t([te({type:Boolean,reflect:!0})],je.prototype,"disabled",2);$t([te({attribute:"aria-label"})],je.prototype,"ariaLabel",2);je=$t([Z("app-button")],je);var Jo=Object.defineProperty,Xo=Object.getOwnPropertyDescriptor,Ss=(s,e,t,i)=>{for(var r=i>1?void 0:i?Xo(e,t):e,n=s.length-1,o;n>=0;n--)(o=s[n])&&(r=(i?o(e,t,r):o(r))||r);return i&&r&&Jo(e,t,r),r};let Qe=class extends B{constructor(){super(...arguments),this.title=""}show(){this.dialogElement.showModal()}close(){this.dialogElement.close()}render(){return C`
      <dialog
  ...
  `;Ss([te({type:String})],Qe.prototype,"title",2);Ss([k("dialog")],Qe.prototype,"dialogElement",2);Qe=Ss([Z("base-dialog")],Qe);var Qo=Object.defineProperty,ea=Object.getOwnPropertyDescriptor,le=(s,e,t,i)=>{for(var r=i>1?void 0:i?ea(e,t):e,n=s.length-1,o;n>=0;n--)(o=s[n])&&(r=(i?o(e,t,r):o(r))||r);return i&&r&&Qo(e,t,r),r};const li="btn-shape";let K=class extends B{constructor(){super(),this.selectedThemeName=localStorage.getItem("user-theme")||"Catppuccin",this.buttonShape=localStorage.getItem(li)==="rounded"?"rounded":localStorage.getItem(li)==="square"?"square":localStorage.getItem("btn-shape-radius")==="50%"?"rounded":"square",this.username="",this.symbol="X",this.symbolError="",this.showEmojiPicker=!1;const e=he.load()??he.getDefaultDraft();this.username=e.username,this.symbol=e.symbol,this.selectedThemeName=e.preferences?.themeName||localStorage.getItem("user-theme")||"Catppuccin",this.buttonShape=e.preferences?.buttonRadius===Se.Rounded?"rounded":"square"}show(){this.baseDialog.show()}handleThemeChange(s){const t=s.target.value;this.selectedThemeName=t,y.emit(m.UI.ThemeChanged,g.WebUI,t)}handleShapeChange(s){return this.buttonShape=s,s==="rounded"?Se.Rounded:Se.Square}saveAndClose(){try{const s={username:this.username,symbol:ue(this.symbol),preferences:{themeName:this.selectedThemeName,buttonRadius:this.buttonShape==="rounded"?Se.Rounded:Se.Square}},e=he.save(s);return this.symbolError="",this.baseDialog.close(),e}catch(s){throw this.symbolError=s instanceof Error?s.message:"Ungültiges Symbol",s}}onEmojiClick(s){this.symbol=ue(s.detail?.unicode??"😀"),this.symbolError="",this.showEmojiPicker=!1}render(){return C`
  ...
  `;Es([A()],et.prototype,"messages",2);Es([D(m.UI.ToastRequested,g.WebUI)],et.prototype,"onToast",1);et=Es([Z("toast-manager")],et);var ua=Object.defineProperty,ha=Object.getOwnPropertyDescriptor,Y=(s,e,t,i)=>{for(var r=i>1?void 0:i?ha(e,t):e,n=s.length-1,o;n>=0;n--)(o=s[n])&&(r=(i?o(e,t,r):o(r))||r);return i&&r&&ua(e,t,r),r};const ci="btn-shape";let F=class extends B{constructor(){super(),this.activeSettings=new re,this.currentThemeName="Catppuccin",this.isPlaying=!1,this.savedRadius="5%",this.initializeUIState()}handleDialogOpen(s){const e=this.shadowRoot?.querySelector(s);e&&typeof e.show=="function"&&e.show()}saveButtonShape(s){this.savedRadius=s,localStorage.setItem(ci,s==="50%"?"rounded":"square")}changeTheme(s,e=!1){const t=xi[s];if(!t)return;const i=()=>{Object.entries(t).forEach(([r,n])=>document.documentElement.style.setProperty(`--${r}`,n)),document.body.className=s.toLowerCase(),this.currentThemeName=s,localStorage.setItem("user-theme",s)};if(e||!document.startViewTransition){i();return}try{document.startViewTransition(()=>i())}catch{i()}}endApp(){this.isPlaying=!1}initializeUIState(){const s=he.load(),e=s?.preferences.themeName||"Catppuccin",t=localStorage.getItem("btn-shape-radius"),r=(localStorage.getItem(ci)??(t==="50%"?"rounded":"square"))==="rounded"?"50%":s?.preferences.buttonRadius||"5%";this.changeTheme(e,!0),this.savedRadius=r}OnStartGame(s){s?.settings&&(this.activeSettings=Object.assign(new re,s.settings),this.isPlaying=!0,this.requestUpdate())}syncSettingsFromDialog(s){this.activeSettings=Object.assign(new re,s)}requestGameStart(){y.emit(m.UI.GameStartRequested,g.WebUI,this.activeSettings)}render(){return C`
    ...
    `}initializeButtonState(){return this.savedRadius}firstUpdated(){this.initializeButtonState(),he.isComplete()||y.emit(m.UI.DialogOpenRequested,g.WebUI,"profile-dialog")}};F.styles=ee`
    :host {
      display: flex;
      width: 100vw;
      height: 100vh;
